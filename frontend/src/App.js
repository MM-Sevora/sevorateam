    ...
    return (
        <Suspense fallback={<LazyLoader />}>
            <Routes>
                ...
                <Route path="/engineering/projects/:projectId/sprint-planning" element={<ProtectedRoute requiredModule="project_management"><EngineeringSprintPlanningPage /></ProtectedRoute>} />
