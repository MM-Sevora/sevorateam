...
export const AIToolsPage = () => {
    ...
    const fetchScheduledSearches = async () => {
        try {
            const response = await marketingAPI.getSearches();
    ...
    const fetchDiscoveryResults = async () => {
        try {
            const response = await marketingAPI.getResults({ limit: 20 });
    ...
    const handleCreateSearch = async () => {
        ...
        setLoading(true);
        try {
            await marketingAPI.createSearch(newSearch);
    ...
    const handleRunNow = async (searchId) => {
        ...
        try {
            const result = await marketingAPI.runNow(searchId);
    ...
    const handleToggleSearch = async (search) => {
        try {
            await marketingAPI.updateSearch(search.id, { is_active: !search.is_active });
            fetchScheduledSearches();
    ...
    const handleDeleteSearch = async (searchId) => {
        ...
        try {
            await marketingAPI.deleteSearch(searchId);
    ...
    const handleGenerateCaption = async () => {
        ...
        setLoading(true);
        try {
            const response = await marketingAPI.generateCaption(captionParams);
    ...
    const handleGetIdeas = async () => {
        setLoading(true);
        try {
            const response = await marketingAPI.getCampaignIdeas(ideaParams);
