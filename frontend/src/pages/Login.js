...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-6" data-testid="login-page">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-zinc-400 text-sm">Sign in to manage your social media</p>
        </div>

        <form onSubmit={handleSubmit} className="glass-surface rounded-2xl p-8 animate-slide-up" data-testid="login-form">
          {error && (
          ...
          <p className="text-center text-zinc-500 text-sm mt-6">
            ...
            <Link to="/register" className="text-accent-violet hover:text-accent-violet-hover transition-colors" data-testid="register-link">
              Create one
            </Link>
          </p>
        </form>
