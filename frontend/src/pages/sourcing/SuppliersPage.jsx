    ...
    <div className="p-6 space-y-6" data-testid="suppliers-page">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900">Supplier Database</h1>
        </div>
        ...
        <CardContent className="p-4">
          <div className="flex flex-wrap gap-4">
            <div className="flex-1 min-w-[200px] relative">
              ...
              <Input value={search} onChange={(e) => setSearch(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && fetchSuppliers()} placeholder="Search suppliers..." className="pl-10" />
            </div>
